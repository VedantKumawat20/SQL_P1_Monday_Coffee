...
-- And
-- Coffee Mug (Ceramic)  -  73  has lowest units of sold
----------------------------------------------------------------------------------------------------------------------
...
-- unique_current_customer and coffee_customer_in_million spearate
...
-- we need sum total, group by city and distinct customer and dividing sum total / distinct customer count to get avg for each city
-- and for avg rent per city also we are dividing rent/distinct customer count. and group by city
-- NOTE- here we are not doing sum of rent because rent is alredy givive for per city
...
-- Jaipur, Kanpur, Pune have the lowest rent among all cities
-- Mumbai, Hyderabad, Bangalore have the highest rent
----------------------------------------------------------------------------------------------------------------------
